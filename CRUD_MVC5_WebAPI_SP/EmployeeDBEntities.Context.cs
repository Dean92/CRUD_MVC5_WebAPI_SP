...
namespace CRUD_MVC5_WebAPI_SP
{
    ...
    public partial class db1Entities : DbContext
    {
        ...
        public virtual int ADDNewEmployee(string emp_Name, string email, string country, Nullable<int> projectID, string managerName, string profileImage)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ADDNewEmployee", emp_NameParameter, emailParameter, countryParameter, projectIDParameter, managerNameParameter, profileImageParameter);
        }
